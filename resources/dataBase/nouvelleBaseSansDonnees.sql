...
--
-- Host: localhost:8889
-- Generation Time: Sep 24, 2021 at 08:42 AM
...
--
ALTER TABLE `categorieRecette`
  MODIFY `idCategorieRecette` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ingredient`
--
ALTER TABLE `ingredient`
  MODIFY `idIngredient` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=208;
